...
class Config:
    def __init__(self, pcc):
        ...
        default_path = os.path.join(home, "pfctoolkit_config", f"{pcc}.json")
        path_without_extension = os.path.join(home, "pfctoolkit_config", pcc)
        
        potential_paths = [default_path, path_without_extension, pcc]
